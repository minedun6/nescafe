...
@section('url-way')
    ...
    <li>
        <a href="#">Ajouter visite branding</a>
    </li>
@stop
...
@section('content')
    ...
    <div class="portlet box dark">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-gift"></i>Ajouter visite branding
            </div>
            <div class="tools">
            </div>
        </div>
        <div class="portlet-body">
            ...
            <div class="panel-group accordion">
                <form action="{{ url('photos/add/branding/'.$visit->id) }}" method="post" enctype="multipart/form-data">
