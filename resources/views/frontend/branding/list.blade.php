            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Liste des visites branding </span>
                    </div>
                    <div class="tools">
                    ...
                    <div class="row" style="margin-top: 20px;">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="rapport_table">
                            ...
                            <tr style="background-color: rgba(2, 2, 2, 0.06)">
                                <th style=" color: #F2784B; width: 15%;"> Date</th>
                                <th style=" color: #F2784B; width: 20%;"> Reseau</th>
                                <th style=" color: #F2784B; width: 15%; text-align: center; "> Type</th>
                                <th style=" color: #F2784B; width: 10%; text-align: center;"> Zone</th>
                                <th style=" color: #F2784B; width: 20%; text-align: center;"> Merchandiser</th>
                                <th style=" color: #F2784B; width: 20%; text-align: center;"> Action</th>
                            </tr>
                            </thead>
                            <tbody>
...
@section('footer')
    ...
    <script>
        ...
        var table = $('#rapport_table').DataTable({
            ...
            "bSort": false,
            "ajax": {
                'url': "{{ url('/pagination_visits/branding') }}",
                'type': 'get',
                'data': function (d) {
