            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Liste des plannings </span>
                    </div>
                    <div class="tools">
                                ...
                                <tr>
                                    ...
                                    <td width="15%" style="padding-left:5px;" id="row2"><input type="text"
                                        ...
                                        <input type="text" name="datefin" id="datefin"
                                               value="{!! Carbon\Carbon::now()->format("d/m/Y") !!}"
                                               class="form-control form-control-inline  date-picker"
                                               placeholder="à" onchange="table.draw();"></td>
                                    @role('Merch')
                                    @else
...
@section('footer')
    ...
    <!--<script type="text/javascript" src="{{ URL::asset('/frontend/assets/scripts/datatablefilter.js') }}"></script>-->
    <script>
