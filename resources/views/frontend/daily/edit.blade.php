        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <form action="{{ url('answers/edit/'.$visit->id) }}" method="post" files="true"
                        ...
                        <table class="table table-striped table-bordered table-hover" id="rapport_table">
                            ...
                            <tbody>
                            @foreach($visit->answers as $index => $answer)
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <label style="color: limegreen">
                                            <input type="radio" name="radio[{{ $index }}]"
                                                   {{ $answer->value == 'ok' ? 'checked' : ''}} value="ok"
                                                   class="icheck"> OK
                                        </label>
                                        <label style="color: darkorange;padding-left: 2px;">
                                            <input type="radio" name="radio[{{ $index }}]" value="na"
                                                   {{ $answer->value == 'na' ? 'checked' : ''}}
                                                   class="icheck"> N/A
                                        </label>
                                        <label style="color: red;padding-left: 2px;">
                                            <input type="radio" name="radio[{{ $index }}]"
                                                   {{ $answer->value == 'ko' ? 'checked' : ''}} value="ko"
                                                   class="icheck"> KO
                                        </label>
                                    </td>
                                    <td style="text-align: center">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <textarea type="text" class="form-control"
                                                                  ...
                                                                  rows="2">{!! $answer->comment != '' ? strip_tags($answer->comment) : ''  !!}</textarea>
                                                    </div>
                                    ...
                                    <td style="display: none"><input type="hidden" name="answer_id[{{ $index }}]"
                                                                     value="{{ $answer->id }}"></td>
                                </tr>
                            @endforeach
                            </tbody>
                            ...
                            <td colspan="4"><textarea class="form-control" rows="2" colspan="4"
                                                      name="note_on_visit">{!! $visit->comment != '' ? strip_tags($visit->comment) : '' !!}</textarea>
                            </td>
                            </tfoot>
                        </table>
                        <div class="row">
