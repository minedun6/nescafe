        ...
        <div class="col-md-8">
            <div class="portlet box dark">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-"></i>Ajouter une boutique
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form action="{{ url('/network/add/boutique') }}" method="post" id="network_form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    ...
                                    <input type="text" class="form-control tel" name="phone1" placeholder="Tel"></div>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Téléphone 2</label>
                                <div class="input-icon right">
                                    <i class="fa fa-mobile-phone"></i>
                                    <input type="text" class="form-control tel" name="phone2" placeholder="Tel2"></div>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Téléphone fixe</label>
                                <div class="input-icon right">
                                    <i class="fa fa-phone-square"></i>
                                    <input type="text" name="land_line" class="form-control tel" placeholder="Tel fixe">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <label>
                                    <input class="form-control" value="true" type="radio" name="smart" id="smart">
                                    Oui
                                </label>
                                <label>
                                    <input class="form-control" value="false" type="radio" name="smart" id="smart"
                                           checked>
                                    Non
                                </label>
                            </div>
