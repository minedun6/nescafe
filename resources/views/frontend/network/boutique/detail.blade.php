...
@section('content')
    <div class="tabbable-line" id="tabs">
        <ul class="nav nav-tabs">
            ...
            <li class="">
                <a href="#tab_15_2" data-toggle="tab"> Dernière visite </a>
            </li>
            <li class="">
            ...
            <li class="">
                <a href="#tab_15_4" data-toggle="tab"> Dernière visite display </a>

            </li>
            <li class="">
                <a href="#tab_15_5" data-toggle="tab" aria-expanded="true" id="tab2"> Dernière visite online </a>
                    ...
                    <div class="col-md-10">
                        <div class="portlet dark box">
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="row static-info">
                                    <div class="col-md-5 name"> Smart ?</div>
                                    <div class="col-md-7 value">
                                        <span class="label label-success">
                                            {{ $network->type->code == 'smart' ? 'Oui' : 'Non' }}
                                        </span>
                                    </div>
                                </div>
                                <div class="row static-info">
            ...
            <div class="tab-pane" id="tab_15_2">
                @if($daily_visit)
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"><b>Commentaire sur visite
                                        : </b></label></br>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="rapport_table">
                        ...
                        @foreach($daily_visit->answers as $answer)
                            <tr>
                                ...
                                <div class="modal fade" id="msg_form_{{$answer->id}}" tabindex="-1" role="basic"
                                     aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <form role="form" action="" method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <span>{!! strip_tags($answer->comment) !!}</span>
