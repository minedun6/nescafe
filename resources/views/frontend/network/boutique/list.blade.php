            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Liste des Boutiques</span>
                    </div>
                    <div class="actions">
                        <a href="{{ url('/network/add/boutique') }}" class="btn btn-sm dark"><i
                                    class="fa fa-plus"></i>Ajouter une boutique</a>
                    </div>
...
@section('footer')
    <script>
        ...
        var table = $('#rapport_table').DataTable({
            ...
            "bSort": false,
            "ajax": {
                'url': "{{ url('/network/paginate/boutique') }}",
                'type': 'get',
                'data': function (d) {
