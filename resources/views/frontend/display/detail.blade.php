            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Détails visite display</span>
                        @if($visit->is_answered_display)
                        ...
                        <div class="dt-buttons">
                            @if(!$visit->is_answered_display)
                                <a class="dt-button buttons-print btn dark btn-outline"
                                   href="{{ url('photos/add/display/'.$visit->id) }}"><i class="fa fa-plus-circle"></i>
                                    Ajouter une visite display</a>
                            @endif
                            @permission('edit-visits') <a class="dt-button buttons-print btn blue-chambray btn-outline"
                                                          data-target="#pop_up"
