            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Liste des visites display </span>
                    </div>
                    <div class="tools">
...
@section('footer')
    ...
    <script src="<?php echo URL::asset('/frontend/assets/global/plugins/jquery-ui/jquery-ui.min.js')?> " type="text/javascript"></script>
    ...
    <script>
        ...
        var table = $('#rapport_table').DataTable({
            ...
            "bSort": false,
            "ajax": {
                'url': "{{ url('/pagination_visits/display') }}",
                'type': 'get',
                'data': function (d) {
