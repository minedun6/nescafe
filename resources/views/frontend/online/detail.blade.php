            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Détails visite online</span>
                        @if($visit->is_answered_online)
                        ...
                        <div class="dt-buttons">
                            @if(!$visit->is_answered_online)
                                <a class="dt-button buttons-print btn dark btn-outline"
                                   href="{{ url('photos/add/online/'.$visit->id) }}"><i class="fa fa-plus-circle"></i>
                                    Ajouter une visite online</a>
                                @permission('edit-visits') <a
                                        class="dt-button buttons-print btn blue-chambray btn-outline"
                                        data-target="#pop_up"
                                        data-toggle="modal" style="padding-left: 3px; "> <i class="fa fa-edit"></i>
                                    Editer
                                    date
                                </a>
                                @endauth
                            ...
                            @if($supervisor_note == true)
                                <a tabindex="0" class="dt-button buttons-print btn blue btn-outline"
                                   data-target="#msg_form" data-toggle="modal"><span>
                                    <i class="fa fa-envelope"></i> Note superviseur</span></a>
                            @endif
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"><b>Adresse
                                        : </b></label></br>
                                <label class="control-label">{!! strip_tags($visit->network->address) !!}</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
