...
@section('url-way')
    ...
    <li>
        <a href="{{url('/visits/online')}}">Visites Online</a>
    </li>
@stop
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Liste des visites online </span>
                    </div>
                    <div class="tools">
                            ...
                            <table id="mytable" style="">
                                ...
                                <tr>
                                    ...
                                    <td width="15%" style="padding-left:5px;" id="row2"><input type="text"
                                                                                               ...
                                                                                               onchange="filtre();document.getElementById('datefin').value=this.value;"
                                                                                               placeholder="De">
                                        <input type="text" name="datefin" id="datefin"
                                               class="form-control form-control-inline  date-picker" onchange="filtre()"
                                               placeholder="à"></td>
                                    ...
                                    <td width="10%"><select type="text" name="merch" id="merch" onchange="filter()"
...
@section('footer')
    ...
    <script>
        ...
        var table = $('#rapport_table').DataTable({
            ...
            "bSort": false,
            "ajax": {
                'url': "{{ url('/pagination_visits/online') }}",
                'type': 'get',
                'data': function (d) {
