...
@section('content')
    @role('Merch')
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-8"></div>
        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-8" style="cursor: pointer"
             onclick="window.location='{{ url('planning') }}'">
            <div class="dashboard-stat red-intense">
                ...
                <div class="details">
                    ...
                    <div class="desc"><i class="fa fa-arrow-right"></i> Mon planning</div>
                </div>

            </div>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-4 col-xs-8" style="cursor: pointer"
             onclick="window.location='{{ url('mydaily') }}'">
            <div class="dashboard-stat blue">
                ...
                <div class="details">
                    ...
                    <div class="desc"><i class="fa fa-check"></i> Mes visites de jour</div>
                </div>

            </div>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-8" style="cursor: pointer"
                   onclick="window.location='{{ url('network/add/pdv') }}'">
            <div class="dashboard-stat red-intense">
                <div class="visual">
                    <i class="fa fa-calendar"></i>
                </div>
                <div class="details">
                    ...
                    <div class="desc"><i class="fa fa-arrow-right"></i> Nouveau PDV</div>
                </div>
        ...
        <div class="col-lg-4 col-md-2 col-sm-6 col-xs-12">
            <div class="dashboard-stat red">
                ...
                <div class="details">
                    ...
                    <div class="desc"> Kiosques dépassant 20% d'anomalie</div>
        ...
        <div class="col-lg-4 col-md-2 col-sm-6 col-xs-12">
            ...
            <div class="dashboard-stat red">
                ...
                <div class="details">
                    ...
                    <div class="desc"> Epiceries dépassant 40% d'anomalie</div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-2 col-sm-6 col-xs-12">
            <div class="dashboard-stat red">
                ...
                <div class="details">
                    ...
                    <div class="desc">Superettes dépassant 30% d'anomalie</div>
        ...
        <div class="col-lg-4 col-md-2 col-sm-6 col-xs-12">
            ...
            <div class="dashboard-stat blue">
                ...
                <div class="details">
                    ...
                    <div class="desc">Visite Photos 1</div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-2 col-sm-6 col-xs-12">
            ...
            <div class="dashboard-stat green-meadow">
                ...
                <div class="details">
                    ...
                    <div class="desc">Visite Photos 2</div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-2 col-sm-6 col-xs-12">
            ...
            <div class="dashboard-stat purple">
                ...
                <div class="details">
                    ...
                    <div class="desc">Visite Photos 3</div>
    ...
    <div class="row" style="margin: 20px;">
        ...
        <table class="table table-striped table-bordered table-hover" id="rapport_table1">
            ...
            @foreach($top_five_anomalies as $visit)
                <tr>
                    <td><a href="{{ url('visits/daily/'.$visit->id) }}">{{ $visit->updated_at->format('d-m-Y') }}</a>
                    </td>
                    <td>
                        <?php
                    ...
                    <td style="text-align:center;"><span class="badge  badge-success">{{ $visit->bmerch.' %' }}</span>
                    </td>
                    <td style="text-align:center;"><span class="badge  badge-danger">{{ $visit->anomalies.' %' }}</span>
                    </td>
                </tr>
            @endforeach
            </tbody>
    ...
    <div class="row" style="margin: 20px;">
        ...
        <div class="col-md-6 nnn">
            <div class="">
                <div class="mt-element-ribbon bg-grey-steel">
                    <div class="ribbon ribbon-color-danger uppercase ">Kiosques</div>
        ...
        <div class="col-md-6 nnn">
            <div class="">
                <div class="mt-element-ribbon bg-grey-steel">
                    <div class="ribbon ribbon-color-danger uppercase ">Epicerie</div>
                    <div style="margin-top:30px;">
        ...
        <div class="col-md-6 nnn">
            <div class="">
                <div class="mt-element-ribbon bg-grey-steel">
                    <div class="ribbon ribbon-color-danger uppercase ">Superette</div>
                    <div style="margin-top:30px;">
...
@section('footer')
    ...
    <script>
        ...
        var data1 = visits_last_four_weeks;
        ...
        var table = $('#rapport_table1').DataTable({
            "processing": false,
            "serverSide": false,
            "iDisplayLength": 5,
            "bPaginate": false,
