...
class PermissionTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $viewFrontend->system       = true;
        $viewFrontend->group_id     = 1;
        $viewFrontend->sort         = 1;
         ...
         */
        $permission_model          = config('access.permission');
        $editVisits               = new $permission_model;
        $editVisits->name         = 'edit-visits';
        $editVisits->display_name = 'Edit Visits';
        $editVisits->system       = true;
        $editVisits->group_id     = 5;
        $editVisits->sort         = 1;
        $editVisits->created_at   = Carbon::now();
        $editVisits->updated_at   = Carbon::now();
        $editVisits->save();

        $permission_model          = config('access.permission');
        $addVisits               = new $permission_model;
        $addVisits->name         = 'add-visits';
        $addVisits->display_name = 'Add Visits';
        $addVisits->system       = true;
        $addVisits->group_id     = 5;
        $addVisits->sort         = 2;
        $addVisits->created_at   = Carbon::now();
        $addVisits->updated_at   = Carbon::now();
        $addVisits->save();

        $permission_model          = config('access.permission');
        $addVisits               = new $permission_model;
        $addVisits->name         = 'view-visits';
        $addVisits->display_name = 'View Visits';
        $addVisits->system       = true;
        $addVisits->group_id     = 5;
        $addVisits->sort         = 3;
        $addVisits->created_at   = Carbon::now();
