 ...
 */
class MedAmineBalti2006Seeder extends Seeder
{
    public function run()
    {
        ...
        $results = Excel::selectSheetsByIndex(0)->load('storage/7.xlsx', function($reader) {})->get();
        $rows = $results->toArray();

        $date_debut = Carbon::create(2016, 6, 20, 0, 0, 0,'Africa/Tunis');
